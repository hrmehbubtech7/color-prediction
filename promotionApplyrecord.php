...
<style>
h3 {
	font-weight:normal; font-family: 'Abel', sans-serif;
}
.tdtext{ font-size:16px !important; color:#090 !important; font-weight:normal; text-align:right; font-family: 'Abel', sans-serif;}
...
<div class="appHeader1">
  <div class="left"> <a href="#" onClick="goBack();" class="icon goBack"> <i class="icon ion-md-arrow-back"></i> </a>
    <div class="pageTitle" style="font-family: 'Abel', sans-serif;">Apply Record</div>
  </div>
</div>
<!-- * App Header --> 
<!-- App Capsule -->
