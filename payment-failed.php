...
<style>
.appHeader1 {font-family: 'Abel', sans-serif;
...
h3{ font-weight:normal; font-family: 'Abel', sans-serif;
font-size:18px;}
.razorpay-payment-button {font-family: 'Abel', sans-serif;
padding: 10px 50px;
color: #fff;
background: #ff2e17;
font-weight: 600;
...
.razorpay-payment-button:hover {font-family: 'Abel', sans-serif;
color: #fff;
background-color: #f33076;
border-color: #f2246e;
cursor:pointer;}
.thanks-title{ font-size:24px; font-family: 'Abel', sans-serif;}
h5{ margin-top:0px !important; font-size:18px; font-family: 'Abel', sans-serif;}
</style>
</head>
...
unset($_SESSION["finalamount"]);
        ...
        <h5 class=" thanks-title2 mt-1">You transaction of <strong>₹ <?php echo number_format($amount,2);?></strong> to 2051 Mall is failed.</h5>
