...
if($category=='parity')
{?>
        <div class="containerrecord text-center" style="background-image: linear-gradient(to bottom,  pink 25%, white 100%);  ">
        <a href="#" class="recordlink">
    <p> <i class="icon ion-md-trophy text-danger"></i> <div class="title text-danger">Parity Record</div> </p>
    </a>
        </div>
        
        <div class="table-container" id="paritycontainer" style="background-image: linear-gradient(to left, white 37%, lightpink 100% );">
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
        ...
        <div class="containerrecord text-center mt-1" style="background-image: linear-gradient(to bottom,  pink, white 100%);">
        <a href="#" class="recordlink">
    <p> <i class="icon ion-md-paper text-danger"></i> <div class="title text-danger">My Parity Record</div> </p>
    </a>
        </div>
        <div class="table-container" id="paritycontainer" style="background-image: linear-gradient(to right, white 37%, lightpink 100% );">
...
{?>
	    <div class="containerrecord text-center" style="background-image: linear-gradient(to bottom,  white 25%, pink 100%);">
        <a href="gamedashboard.php" class="recordlink">
    <p> <i class="icon ion-md-trophy text-danger"></i> <div class="title text-danger">Sapre Record</div> </p>
    </a>
        </div>
        <div class="table-container" id="paritycontainer" style="background-image: linear-gradient(to left, white 37%, lightpink 100% );">
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
        ...
        <div class="containerrecord text-center mt-1" style="background-image: linear-gradient(to bottom,  pink 25%, pink 100%);">
        <a href="#" class="recordlink">
    <p> <i class="icon ion-md-paper text-danger"></i> <div class="title text-danger">My Sapre Record</div> </p>
    </a>
        </div>
        <div class="table-container" id="paritycontainer" style="background-image: linear-gradient(to right, white 37%, lightpink 100% );">
...
{
?>
<div class="containerrecord text-center" style="background-image: linear-gradient(to bottom,  pink 25%, pink 100%);">
        <a href="gamedashboard.php" class="recordlink">
    <p> <i class="icon ion-md-trophy text-danger"></i> <div class="title text-danger">Bcone Record</div> </p>
    </a>
        </div>        
        <div class="table-container" id="paritycontainer" style="background-image: linear-gradient(to left, white 37%, lightpink 100% );">
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
        ...
        <div class="containerrecord text-center mt-1" style="background-image: linear-gradient(to bottom,  pink 25%, pink 100%);">
        <a href="#" class="recordlink">
    <p> <i class="icon ion-md-paper text-danger"></i> <div class="title text-danger">My Bcone Record</div> </p>
    </a>
        </div>
        <div class="table-container" id="paritycontainer" style="background-image: linear-gradient(to right, white 37%, lightpink 100% );">
...
<?php
 ...
 ?>
         <div class="containerrecord text-center" style="background-image: linear-gradient(to bottom,  pink 25%, pink 100%);">
        <a href="gamedashboard.php" class="recordlink">
    <p> <i class="icon ion-md-trophy text-danger"></i> <div class="title text-danger">Emerd Record</div> </p>
    </a>
        </div>
        <div class="table-container" id="paritycontainer" style="background-image: linear-gradient(to left, white 37%, lightpink 100% );">
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
        ...
        <div class="containerrecord text-center mt-1" style="background-image: linear-gradient(to bottom,  pink 25%, pink 100%);">
        <a href="#" class="recordlink">
    <p> <i class="icon ion-md-paper text-danger"></i> <div class="title text-danger">My Emerd Record</div> </p>
    </a>
        </div>
        <div class="table-container" id="paritycontainer" style="background-image: linear-gradient(to right, white 37%, lightpink 100% );">
