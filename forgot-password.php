...
<style>
#alert .modal-dialog{padding:20px; font-family: 'Abel', sans-serif; margin-top:130px;}
#registertoast .modal-dialog{padding:0px;font-family: 'Abel', sans-serif; margin-top:130px;}
...
<div class="appHeader1">
  <div class="left"> <a href="login.php" class="icon goBack"> <i class="icon ion-md-arrow-back"></i> </a>
    <div class="pageTitle" style="font-family: 'Abel', sans-serif;">Reset Password</div>
  </div>
</div>
<!-- searchBox --> 
  ...
  <div class="appContent1 pb-0">
    <form action="#" id="forgotform">
      <div class="inner-addon left-addon"> <i class="icon ion-md-phone-portrait"></i>
        <input type="tel" style="font-family: 'Abel', sans-serif;" class="form-control" placeholder="Mobile Number" id="fmobile" name="fmobile" onKeyPress="return isNumber(event)">
        <input type="hidden" name="type" id="type" value="chkmobile">
      </div>
      <div class="text-center mt-3">
        <button type="submit" class="btn btn-maroon" style="width:260px;  font-family: 'Abel', sans-serif;"> Continue </button>
      </div>
    </form>
  </div>
</div>
